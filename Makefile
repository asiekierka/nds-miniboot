...
$(NDSROM_M3DS): arm9_nobootstub arm7 $(NDSROM_M3DS_DLDI) $(SCRIPT_DSBIZE)
	@$(MKDIR) -p $(@D)
	@echo "  NDSTOOL $@"
	$(_V)$(BLOCKSDS)/tools/ndstool/ndstool -c $@ \
...
$(NDSROM_ITDS_ENG): arm9_nobootstub arm7 $(NDSROM_M3DS_DLDI) $(SCRIPT_DSBIZE)
	@$(MKDIR) -p $(@D)
	@echo "  NDSTOOL $@"
	$(_V)$(BLOCKSDS)/tools/ndstool/ndstool -c $@ \
		-9 build/arm9_nobootstub.bin -7 build/arm7.bin \
	...
	$(_V)$(DLDIPATCH) patch $(NDSROM_M3DS_DLDI) $@
	@echo "  DSBIZE  $@"
	$(_V)$(LUA) $(SCRIPT_DSBIZE) $@ 32

$(NDSROM_ITDS_GB): arm9_nobootstub arm7 $(NDSROM_M3DS_DLDI) $(SCRIPT_DSBIZE)
	@$(MKDIR) -p $(@D)
	@echo "  NDSTOOL $@"
	$(_V)$(BLOCKSDS)/tools/ndstool/ndstool -c $@ \
		-9 build/arm9_nobootstub.bin -7 build/arm7.bin \
	...
	$(_V)$(DLDIPATCH) patch $(NDSROM_M3DS_DLDI) $@
	@echo "  DSBIZE  $@"
	$(_V)$(LUA) $(SCRIPT_DSBIZE) $@ 33

$(NDSROM_ITDS_JP): arm9_nobootstub arm7 $(NDSROM_M3DS_DLDI) $(SCRIPT_DSBIZE)
	@$(MKDIR) -p $(@D)
	@echo "  NDSTOOL $@"
	$(_V)$(BLOCKSDS)/tools/ndstool/ndstool -c $@ \
		-9 build/arm9_nobootstub.bin -7 build/arm7.bin \
	...
	$(_V)$(DLDIPATCH) patch $(NDSROM_M3DS_DLDI) $@
	@echo "  DSBIZE  $@"
	$(_V)$(LUA) $(SCRIPT_DSBIZE) $@ 37

$(NDSROM_R4IRTSB) $(NDSROM_R4RTS): arm9_nobootstub arm7 $(NDSROM_M3DS_DLDI) $(SCRIPT_DSBIZE)
	@$(MKDIR) -p $(@D)
	@echo "  NDSTOOL $@"
	$(_V)$(BLOCKSDS)/tools/ndstool/ndstool -c $@ \
		-9 build/arm9_nobootstub.bin -7 build/arm7.bin \
